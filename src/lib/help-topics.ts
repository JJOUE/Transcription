...
export const HELP_TOPICS: HelpTopic[] = [
  ...
  { id: 'choose-service', label: 'Which transcription service should I choose?', answer: 'Use Transcript Workspace for self-service AI transcription and editing. Professional Transcription includes Hybrid Transcription, which starts with AI and is professionally reviewed, and Human Transcription, which is created from the original audio without an AI-generated draft.', href: '/pricing', linkLabel: 'Compare services and pricing' },
