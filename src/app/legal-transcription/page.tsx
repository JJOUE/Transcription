...
export const metadata: Metadata = {
  ...
  description: 'Professional legal transcription services in Canada for IRB hearings, immigration matters, legal interviews, statements, dictation, and law office workflows. AI transcription, human review, Canadian English, and secure dashboard delivery available.',
